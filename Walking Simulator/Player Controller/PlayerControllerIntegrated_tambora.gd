...
func _ready():
	...
	GameLogger.info("Integrated Player Controller (Tambora) initialized")
	GameLogger.info("Features: Complex Physics + Complex Camera + Input Actions + Joystick + Animations")
